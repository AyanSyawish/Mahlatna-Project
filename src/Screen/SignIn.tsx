        ...
        <ScrollView contentContainerStyle={styles.scrollView}>
          <View style={styles.container}>
            ...
            <View style={styles.row}>
              <Text style={styles.text1}>انشاء حساب جديد</Text>
            ...
            <Text style={styles.text2}>يمكنك الان انشاء حسابك</Text>
            ...
            <View style={styles.imageContainer}>
              ...
              />
              <Text style={styles.text3}>انضم الينا</Text>
            </View>
            <View>
              ...
              <View>
                <TouchableOpacity style={styles.butttonSign}>
                  <Text style={styles.buttonText}>انشاء حساب جديد</Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.SignIn}>
                ...
                <Text style={{ fontWeight: 200 }}> لديك حساب ؟</Text>
              </View>
            </View>
          </View>
        </ScrollView>
